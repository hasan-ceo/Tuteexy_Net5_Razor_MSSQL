...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tuteexy.Models.ClassworkAttendance", b =>
                {
                    b.Property<long>("ClassworkAttendanceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ClassworkAttendanceID");

                    b.HasIndex("ClassworkID");

                    b.HasIndex("StudentID");

                    b.ToTable("LmsClassworkAttendance");
                });

            modelBuilder.Entity("Tuteexy.Models.ClassworkSheet", b =>
                {
                    b.Property<long>("ClassworkSheetID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ClassworkSheetID");

                    b.HasIndex("ClassworkID");

                    b.HasIndex("UserID");

                    b.ToTable("LmsClassworkSheet");
                });

            modelBuilder.Entity("Tuteexy.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("Tuteexy.Models.CourseThread", b =>
                {
                    b.Property<long>("CourseThreadID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tuteexy.Models.ShortStory", b =>
                {
                    b.Property<long>("ShortStoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ShortStoryID");

                    b.HasIndex("UserID");

                    b.ToTable("HubShortStory");
                });

            modelBuilder.Entity("Tuteexy.Models.ShortStoryThread", b =>
                {
                    b.Property<long>("ShortStoryThreadID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ShortStoryThreadID");

                    b.HasIndex("ShortStoryID");

                    b.HasIndex("UserID");

                    b.ToTable("HubShortStoryThread");
                });
            ...
            modelBuilder.Entity("Tuteexy.Models.UserProfile", b =>
                {
                    ...
                    b.Property<string>("ECPersonEmail")
                        .IsRequired()
                        .HasColumnType("nvarchar(150)")
                        .HasMaxLength(150);
            ...
            modelBuilder.Entity("Tuteexy.Models.ClassworkAttendance", b =>
                {
                    b.HasOne("Tuteexy.Models.Classwork", "Classwork")
                        .WithMany()
            ...
            modelBuilder.Entity("Tuteexy.Models.CourseThread", b =>
                {
                    b.HasOne("Tuteexy.Models.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("Tuteexy.Models.ShortStoryThread", b =>
                {
                    b.HasOne("Tuteexy.Models.ShortStory", "ShortStory")
                        .WithMany()
